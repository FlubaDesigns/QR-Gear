...
export const adminSettings = pgTable("admin_settings", {
  ...
  defaultFulfillmentProvider: text("default_fulfillment_provider").default("printify"), // 'printify' or 'printful'
  defaultMockupProvider: text("default_mockup_provider").default("printful"), // 'printify' or 'printful'
  updatedAt: timestamp("updated_at").defaultNow().notNull(),
});
...
export const libraryAssets = pgTable("library_assets", {
  ...
  assetType: text("asset_type").notNull(), // 'background', 'cropped', or 'design'
  ...
  // Cropping support
  sourceAssetId: varchar("source_asset_id"), // for cropped: references the source asset id
