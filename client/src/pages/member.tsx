                    ...
                    <SkinGridViewer
                      ...
                      actions={{
                        onEdit: (id) => {
                          ...
                          if (product?.packetId) {
                            setLocation(`/admin/store-builder?packetId=${product.packetId}`);
                          }
                        },
                      }}
            ...
            <TabsContent value="products" className="mt-4">
              <Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  <Link href="/admin/dynamics" className="block">
