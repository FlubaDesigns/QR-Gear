...
const productLineConfig: Record<ProductLine, {
  ...
  "static": {
    label: "QR Basics",
    description: "Permanent QR code with text, URL, or contact info",
    icon: Type,
    qrTypes: ["text"],
  ...
  "url": {
    label: "QR Canvas",
    description: "Custom background image on scan destination",
    icon: Image,
    qrTypes: ["template"],
  ...
  "video": {
    label: "QR Play",
    description: "Video playback when scanned",
    icon: Video,
    qrTypes: ["upload"],
  ...
  "dynamics": {
    label: "QR Dynamics",
    description: "Updateable destination with analytics",
    icon: Sparkles,
    qrTypes: ["dynamic"],
