    ...
    try {
      ...
      const packetPayload = {
        ...
        boundProduct: {
          ...
          description: product.memberPacketDescription || product.customDescription || product.description || '',
          providerDescription: product.providerDescription || product.originalDescription || '',
          adminCatalogDescription: product.adminCatalogDescription || product.adminDescription || '',
          memberPacketDescription: product.memberPacketDescription || product.customDescription || '',
          effectiveDescription: product.memberPacketDescription || product.customDescription || product.adminCatalogDescription || product.adminDescription || product.providerDescription || product.description || product.originalDescription || '',
    ...
    try {
      ...
      const packetData: Record<string, any> = {
        ...
        boundProduct: selectedProductType ? {
          ...
          description: selectedProductType.memberPacketDescription || selectedProductType.customDescription || selectedProductType.description || '',
          providerDescription: selectedProductType.providerDescription || selectedProductType.originalDescription || '',
          adminCatalogDescription: selectedProductType.adminCatalogDescription || selectedProductType.adminDescription || '',
          memberPacketDescription: selectedProductType.memberPacketDescription || selectedProductType.customDescription || '',
          effectiveDescription: selectedProductType.memberPacketDescription || selectedProductType.customDescription || selectedProductType.adminCatalogDescription || selectedProductType.adminDescription || selectedProductType.providerDescription || selectedProductType.description || selectedProductType.originalDescription || '',
          originalDescription: selectedProductType.originalDescription || '',
          adminDescription: selectedProductType.adminDescription || '',
          customDescription: selectedProductType.customDescription || '',
        } : null,
