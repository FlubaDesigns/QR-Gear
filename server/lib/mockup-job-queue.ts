                ...
                try {
                  ...
                  if (instanceSnap.exists) {
                    ...
                    if (!existingImages[0] || existingImages[0] !== bestUrl) {
                      ...
                      console.log(`[JobQueue] Updated instance ${ownerInstanceId} resolved.images with mockup`);
                    }
                  }
                } catch (instanceErr) {
                  console.error(`[JobQueue] Failed to write-back mockup to instance ${ownerInstanceId}:`, instanceErr);
                }
              }
            }
          }
