...
export function register(app: express.Express): void {
   ...
   */
  app.get('/api/products/canonical/:qrgCode', async (req: Request, res: Response): Promise<void> => {
    try {
   ...
   */
  app.post('/api/products/canonical/batch', async (req: Request, res: Response): Promise<void> => {
    try {
