...
import { BrandingAdapter, NexusMailMeta } from '../../../shared/nexusmail';
...
export class QRGearBrandingAdapter implements BrandingAdapter {
  private baseUrl: string;

  constructor(baseUrl: string = 'https://qrgear-c1ffd.web.app') {
...
export function createQRGearBranding(baseUrl?: string): QRGearBrandingAdapter {
