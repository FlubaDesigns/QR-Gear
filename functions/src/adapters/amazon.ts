...
export async function createListing(surface: SurfaceInput, _account: AccountInput): Promise<MarketplaceResult> {
  ...
  if (!sellerId) return { success: false, error: 'AMAZON_SELLER_ID not configured' };
...
export async function updateListing(_externalListingId: string, surface: SurfaceInput, account: AccountInput): Promise<MarketplaceResult> {
