  ...
  try {
    ...
    const templates = snapshot.docs.map((d: any) => {
      ...
      const packet = hasPacketData ? {
        ...
        placementSizes: data.placementSizes || {},
        placementMethods: data.placementMethods || {},
        defaultColor: data.defaultColor || null,
        defaultColorHex: data.defaultColorHex || null,
        landingPageTitle: data.landingPageTitle || data.name || null,
        landingPageDescription: data.landingPageDescription || data.description || null,
