...
export function register(app: express.Express): void {
  ...
  app.get('/marketplace/ebay/oauth/start', requireAdmin, async (req: Request, res: Response): Promise<void> => {
    try {
  ...
  app.get('/marketplace/ebay/oauth/callback', async (req: Request, res: Response): Promise<void> => {
    ...
    try {
      ...
      if (userId) updates.ebayUserId = userId;
      if (username) updates.ebayUsername = username;
  ...
  app.delete('/admin/surfaces/accounts/:accountId/ebay-disconnect', requireAdmin, async (req: Request, res: Response): Promise<void> => {
    try {
