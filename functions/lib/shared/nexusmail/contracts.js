...
exports.SiteTriggerEnablement = exports.TriggerRegistry = void 0;
exports.getTriggerContract = getTriggerContract;
exports.isTriggerEnabled = isTriggerEnabled;
exports.getEnabledTriggers = getEnabledTriggers;
// ============================================================================
// TRIGGER REGISTRY
// ============================================================================
 ...
 */
function getTriggerContract(triggerName) {
    return exports.TriggerRegistry[triggerName];
}
/**
 * Check if a trigger is enabled for a specific site.
 */
function isTriggerEnabled(triggerName, siteId) {
    const enabledTriggers = exports.SiteTriggerEnablement[siteId] || exports.SiteTriggerEnablement.default;
    return enabledTriggers.includes(triggerName);
}
/**
 * Get all enabled triggers for a site.
 */
function getEnabledTriggers(siteId) {
    const enabledNames = exports.SiteTriggerEnablement[siteId] || exports.SiteTriggerEnablement.default;
    return enabledNames
        .map((name) => exports.TriggerRegistry[name])
