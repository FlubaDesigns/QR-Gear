...
app.post('/test/packets', async (req, res) => {
    try {
        const { qrOnlyUrl, compositeUrl, qrContent, headerText, footerText, pricing, productId, productName, blueprintId, printProviderId, qrProductState, placements, sizes, colors } = req.body;
