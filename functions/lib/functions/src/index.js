...
const bld_1 = require("./routes/bld");
const assemblies_1 = require("./routes/assemblies");
...
const admin_graphics_1 = require("./routes/admin-graphics");
const admin_library_crop_1 = require("./routes/admin-library-crop");
const admin_library_source_1 = require("./routes/admin-library-source");
const products_canonical_1 = require("./routes/products-canonical");
...
(0, admin_dashboard_1.register)(app);
...
(0, bld_1.registerBld)(app);
(0, assemblies_1.registerAssemblies)(app);
...
(0, admin_graphics_1.registerAdminGraphics)(app);
(0, admin_library_crop_1.registerAdminLibraryCrop)(app);
(0, admin_library_source_1.registerAdminLibrarySource)(app);
(0, products_canonical_1.register)(app);
