...
exports.DEFAULT_BLUEPRINT_MAPPINGS = void 0;
exports.generateMockupFromPrintful = generateMockupFromPrintful;
exports.processMockupResult = processMockupResult;
exports.getPrintfulProductId = getPrintfulProductId;
...
exports.DEFAULT_BLUEPRINT_MAPPINGS = DEFAULT_BLUEPRINT_MAPPINGS;
...
async function getPrintfulProductId(blueprintId) {
    ...
    const mappingSnapshot = await core_1.db.collection('printify_printful_mapping')
...
async function generateMockupFromPrintful(request) {
    ...
    const cacheDoc = await core_1.db.collection('mockup_cache').doc(cacheKey).get();
    if (cacheDoc.exists) {
    ...
    const variants = await printful_1.printfulClient.getVariantsByColor(printfulProductId, colorName);
    ...
    const printfileData = await printful_1.printfulClient.getPrintfiles(printfulProductId);
    ...
    const placement = (0, core_1.toProviderPlacement)('printful', canonicalPlacement, availPlacements, request.printMethod);
    ...
    if (availPlacements.includes('label_inside')) {
        ...
        mockupFiles.push({
            ...
            image_url: core_1.QR_GEAR_BRANDED_TAG_URL,
            position: {
