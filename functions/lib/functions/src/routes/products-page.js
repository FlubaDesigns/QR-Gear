...
function register(app) {
    ...
    app.get('/admin/fulfillment-providers', middleware_1.requireAdmin, async (_req, res) => {
        try {
            ...
            const printfulKey = process.env.PRINTFUL_API_KEY || (0, printful_2.getPrintfulApiKey)();
    ...
    app.patch('/admin/store-product-links/:linkId', middleware_1.requireAdmin, async (req, res) => {
        try {
            ...
            await docRef.update({ ...stripUndef(updates), updatedAt: core_1.admin.firestore.FieldValue.serverTimestamp() });
