...
A BLD record captures a reusable product build configuration —
layer layouts, text styling, graphic positioning — independent
of any specific product, packet, or GRF asset. It is the third
identity namespace alongside QRG (product/instance) and GRF
(graphic asset).
...
BLD-UI3010203-001  URL · Image · 3 text overlays · build #001
BLD-UV2 0102-001   URL · Video · 2 instances · build #001
