...
## Recent Changes Log
- 2025-12-22: Fixed Partner Store product config - switches and color swatches now visible for ALL products (not just selected), checkbox only controls inclusion
